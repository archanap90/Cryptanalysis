/*
Project1: Cryptanalysis of Polyalphabetic Substitution cipher
Authors: Archana Purushothama, Prashanth Venkatesh
File Description - Header file containing "Dictionary1" used for the Cryptanalyis.
...
//Dictionary1 
const char DICTIONARY1[] = { "most organizations today dependontheuse of data in two general ways standard business processes u"
...
"n figure the virtuous cycle consists of five stages during the first stage the practitioner seeks t"
...
"dimensions of data quality will be isolated the selected dimensions will beused to list specific me"
